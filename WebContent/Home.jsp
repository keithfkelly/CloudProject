	...
	<div id="content">
		<div id="colOne">
			<form action="TrainServlet">
				<br /> <B>Please Select a Station: </B><br /> <br /> <select
					name="StationCode">
				...
				</select> <br /> <br /> <b>Please Enter your Phone Number:<br />
				</b><br /> <input type="text" name="phone"> <br /> <br /> <input
					type="radio" name="comms" value="sms"><b>SMS it To Me <input
					type="radio" name="comms" value="call">Call Me
				</b> <br /> <br /> <input type="submit" value="Give me Train Times!">
			</form>
		</div>
	</div>
	<div id="footer">
